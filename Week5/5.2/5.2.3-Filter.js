...
// },
  ...
  let filteredData = data.filter(comp => comp.completed == false);
//   console.log(filteredData);
  // filter for user 6's tasks
  let six = data.filter(chump => chump.userId === 6);
//   console.log(six);
  // filter for tasks with a title less than 24 characters long
  let titgirth = data.filter(twofour => twofour.title.length < 24);
  console.log(titgirth);